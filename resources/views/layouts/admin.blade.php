...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('layout/admin/style.css') }}">
...
<body class="admin-body">
    ...
    <div class="admin-wrapper">
        ...
        <aside class="admin-sidebar">
            ...
            <!-- Navigation -->
            <nav class="admin-nav">
                <a href="{{ url('/admin/departments') }}" class="admin-nav-link">
                ...
                <a href="{{ url('/admin/students') }}" class="admin-nav-link">
                    <svg class="admin-nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ url('/admin/courses') }}" class="admin-nav-link">
                    <svg class="admin-nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ url('/admin/professors') }}" class="admin-nav-link">
                    <svg class="admin-nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ url('/admin/enrollments') }}" class="admin-nav-link">
                    <svg class="admin-nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
