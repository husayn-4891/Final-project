            ...
            <div class="user-nav-flex">
                ...
                <div class="user-right-icons">
                    ...
                    <div class="user-profile-dropdown">
                        <a href="{{ route('admin.login') }}" class="d-flex align-items-center gap-2 text-decoration-none">
                            <span class="fw-medium text-secondary">Log In</span>
                            <svg class="user-icon-svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" style="width: 24px; height: 24px;">
