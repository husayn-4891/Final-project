...
<div class="container py-4">
    <div class="mb-4">
        <h1 class="mb-1">Add Enrollment</h1>
        <p class="text-muted mb-0">Enroll a student in a course with a professor.</p>
    </div>
                ...
                <div class="mb-3">
                    ...
                    <select name="studentId" class="form-select" required>
                        ...
                        @foreach($students as $student)
                            <option value="{{ $student->id }}" @selected(old('studentId') == $student->id)>
                ...
                <div class="mb-3">
                    ...
                    <select name="professorId" class="form-select" required>
                        ...
                        @foreach($professors as $professor)
                            <option value="{{ $professor->id }}" @selected(old('professorId') == $professor->id)>
